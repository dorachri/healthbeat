...
<body class="bg-grey">
	...
	<div class="container bg-white">
		<div class="page-header">
			<h2 class="col-sm-offset-1">About</h2>
		</div>
		...
		<div class="row col-sm-offset-1">
		    ...
		    <div class="col-sm-8">
				...
				<p>The service makes possible for the patient to make an appointment through his computer. The patient choose the criteria he wants and search for an available appointment.</p>
		    </div>
		</div>
		<div class="row col-sm-offset-1">
		    <div class="col-sm-2 text-center">
		    	<span class="glyphicon glyphicon-calendar text-info logo"></span>
		    </div>
		    <div class="col-sm-8">
		    	<h3 class="text-primary">Day and hour for appointment</h3>
				<p>The search results show the doctor's weekly availability. The patient could choose the day and hour for the appointment.</p>
		    </div>
		</div>
		<div class="row col-sm-offset-1">
		    <div class="col-sm-2 text-center">
		    	<span class="glyphicon glyphicon-user text-info logo"></span>
		    </div>
		    <div class="col-sm-8">
		    	<h3 class="text-primary">Personal profile</h3>
				<p>The patients could create an account for free. Through the application they could see their appointments history and make an appointment for free.</p>
			</div>
		</div>
	</div>
