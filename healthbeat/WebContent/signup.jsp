...
<body class="bg-grey">
	...
	<div class="wrapper">
		<form class="form-horizontal form-md bg-white" method="post" action="/healthbeat/SignupServlet">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input name="amka" type="text" pattern="[0-9]{11}" placeholder="11 digits number" class="form-control" required="required"/>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<div class="input-group">
						...
						<input name="username" type="text" placeholder="Example: nick25" class="form-control" required="required"/>
					</div>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
						<input name="password2" type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,15}" placeholder="Repeat password" 
			...
			<p class="text-center">By creating an account you accept the <a href="terms.jsp">terms of use</a>.</p>
			<hr/><br/>
			<p class="text-center">If you are already a member: <a href="login.jsp">Login</a></p>
		</form>
	</div>
